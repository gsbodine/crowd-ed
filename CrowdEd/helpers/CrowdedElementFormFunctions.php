 ...
 * @desc based on Omeka_ThemeHelpers: Omeka_View_Helper
 * @version $Id$
...
/**
 * Generate form markup for entering element text metadata.
 *
 * @package CrowdEd
 **/
class Zend_View_Helper_CrowdedElementForm {
    /**
    ...
    public function crowdedElementForm(Element $element, Omeka_Record $record) {
